...
#define STRING_CONFIG_H_AUTHOR "Arjan Mels" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "AM Ender-3"
...
#define DEFAULT_TRAVEL_FEEDRATE_XY_MM 150
#define DEFAULT_EXTRUDE_FEEDRATE_XY_MM 25
#define DEFAULT_TRAVEL_FEEDRATE_Z_MM 10
...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 1000, 1000, 60, 500 } // ...or, set your own edit limits
#endif
...
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 5000, 5000, 1000, 10000 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -10, -1.175 }
...
#define XY_PROBE_SPEED DEFAULT_TRAVEL_FEEDRATE_XY_MM

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_SPEED_FAST DEFAULT_TRAVEL_FEEDRATE_Z_MM
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define G26_XY_FEEDRATE         DEFAULT_EXTRUDE_FEEDRATE_XY_MM    // (mm/s) Feedrate for G26 XY moves.
    #define G26_XY_FEEDRATE_TRAVEL  DEFAULT_TRAVEL_FEEDRATE_XY_MM    // (mm/s) Feedrate for G26 XY travel moves.
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_XY_FEEDRATE DEFAULT_TRAVEL_FEEDRATE_XY_MM   // (mm/s) X and Y axes feedrate (also used for delta Z axis)
  #define NOZZLE_PARK_Z_FEEDRATE  DEFAULT_TRAVEL_FEEDRATE_Z_MM   // (mm/s) Z axis feedrate (not used for delta printers)
#endif
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { {  10, 20, (Z_MIN_POS + 0) } }
  #define NOZZLE_CLEAN_END_POINT   { {  20, Y_BED_SIZE-20, (Z_MIN_POS + 0) } }

  // Circular pattern radius
  #define NOZZLE_CLEAN_CIRCLE_RADIUS 6.5
  // Circular pattern circle fragments number
  #define NOZZLE_CLEAN_CIRCLE_FN 40
  ...
  // absolute coordinates; relative extruder; reset extruder count; move Z to 5mm; move X,Y to 2,10mm; move Z to 0.28; unretract filament; draw line to Y=190mm; draw line to X=2.4mm; draw line to Y=10mm; retract filament; wait to finish
